...
ipcMain.handle(
  "decode-audio-data",
  async (_event: any, arrayBuffer: ArrayBuffer) => {
    ...
    try {
      ...
      if (decodedData instanceof NodeAudioBuffer) {
        ...
        const bufferData = {
          ...
          data: Array.from({ length: decodedData.numberOfChannels }, (_, i) =>
        ...
        throw new Error(
          "Decoded buffer does not have expected AudioBuffer properties",
        );
      }
    } catch (error) {
